    ...
    return (
        <section className='grid grid-cols-2 mt-28 gap-x-7'>
          <div className='w-full h-12'>
            ...
            <h2 className="text-text-title text-3xl mt-5">Prazer, Bruno.</h2>
            ...
            <span className='text-text-title w-max underline font-light mt-5 block hover:opacity-70 hover:text-red transition-all duration-200 cursor-pointer'>
