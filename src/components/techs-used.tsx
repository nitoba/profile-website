    ...
    <>
      ...
      <section id="techs" className="lg:mt-36 md:mt-48 mt-24">
        ...
        <div className="grid md:grid-cols-3 grid-cols-1 mt-16 gap-4">
          <div
            onClick={() => selectTech('node')}
            className="cursor-pointer hover:brightness-90 transition-all duration-300 group bg-background-fg gap-y-5 rounded-2xl flex flex-col items-center justify-center p-4"
          >
            <img
          ...
          >
            <img
              ...
              alt="React Js Icon"
            />
            <h1 className="text-text-title text-center">
              Front End - React Js
            </h1>
          </div>
          <div
            onClick={() => selectTech('flutter')}
            className="cursor-pointer hover:brightness-90 transition-all duration-300 group bg-background-fg gap-y-5 rounded-2xl flex flex-col items-center justify-center p-4"
          >
            <img
              className="w-16 transition-all duration-300 group-hover:translate-y-2"
